import { Injectable, signal, inject, makeStateKey, TransferState } from "@angular/core";
...
export class EventStore {
  ...
  async load(slug: string): Promise<void> {
    ...
    console.log('[EventStore] Platform:', this.platform.isServer ? 'server' : 'browser');
    console.log('[EventStore] TransferState has key?', this.transferState.hasKey(EVENT_STATE_KEY));
