...
export const EVENTS_ROUTES: Routes = [
  ...
  },
  {
    ...
    loadComponent: () => import('./feature/event-list-container/event-list-container.component')
  ...
  },
  {
    path: 'new',
    canActivate: [authGuard],
    loadComponent: () => import('./feature/create-event-container/create-event-container.component')
      .then(m => m.CreateEventContainerComponent),
  },
  {
    path: ':slug',
    loadComponent: () => import('./feature/event-detail-container/event-detail-container.component')
